...
urlpatterns = [
    # Location
    path('locations/', views.location_list, name='location_list'),  # 여기 수정
    ...
    # Car
    path('stations/<int:station_pk>/cars/', views.car_create, name='car_create'),
    path('cars/<int:car_pk>/', views.car_detail, name='car_detail'),
]